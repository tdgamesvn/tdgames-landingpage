...
const MOCK_PROJECTS: ProjectCard[] = [
  ...
  },
  {
    ...
    title: "2D Character",
    subtitle: "Character Design",
    image: "https://cdn.tdgamestudio.com/landing/sinspired/2D-Art-min-947x1024.jpg",
    category: "2D Art",
  },
  {
    id: "13",
    ...
    image: "https://cdn.tdgamestudio.com/landing/sinspired/character_1-min-1024x970.jpg",
    category: "Concept Art",
  },
  {
    id: "14",
    ...
    image: "https://cdn.tdgamestudio.com/landing/sinspired/character_5-min-1024x970.jpg",
    category: "Concept Art",
  },
  {
    id: "15",
    ...
    <>
      ...
      <main className="min-h-screen bg-black">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black py-24 pt-32">
          <div className="absolute inset-0 bg-[url('https://cdn.tdgamestudio.com/landing/images/bgright.png')] bg-cover bg-center opacity-10" />
