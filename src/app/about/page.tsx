      ...
      <main className="bg-[#0a0a0a] text-white">
        ...
        <section className="border-b border-white/10 py-16 md:py-20">
          ...
          >
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                { img: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/Screenshot 2026-05-13 232709.png", label: "KAYN SNOW MOON" },
                { img: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/summonerDetail.png", label: "SUMMONER ERA" },
                { img: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/service-animation.jpg", label: "ANIMATION" },
                { img: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/ourproject.jpg", label: "BATTLE OF GODS" },
              ].map((item, i) => (
