...
const characterMarqueeFilters: MarqueeFilter[] = [
  {
    ...
    label: "3D Characters",
    images: [
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_1-min-1024x970.jpg", alt: "Character 1" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_5-min-1024x970.jpg", alt: "Character 2" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_6-min-1024x970.jpg", alt: "Character 3" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_8-min-1024x970.jpg", alt: "Character 4" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_10-min-1024x970.jpg", alt: "Character 5" },
    ],
  },
  {
    id: "props",
    label: "3D Props",
    images: [
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/lab_asset-min-1024x506.jpg", alt: "Prop 1" },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Volcano_Arena_render-min-1024x567.jpg",
        alt: "Prop 2",
      },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Artboard-1-copy-13-min-1024x572.jpg", alt: "Scene 1" },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/space_arena_source_nature_render_final-min-1024x599.jpg",
        alt: "Scene 2",
      },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/lab_asset_dark_final-min-1024x506.jpg",
        alt: "Scene 3",
      },
    ],
  },
  {
    ...
    label: "Backgrounds",
    images: [
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Artboard-2-copy-4-1024x850.jpg", alt: "Background 1" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Artboard-2-copy-1024x850.jpg", alt: "Background 2" },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Artboard-1-copy-11-min-1024x572.jpg",
        alt: "Background 3",
      },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Artboard-1-copy-13-min-1024x572.jpg",
        alt: "Background 4",
      },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/space_arena_source_nature_render_final-min-1024x599.jpg",
  ...
  },
  {
    ...
    images: [
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/Character-Design-min-822x1024.jpg", alt: "Design 1" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/2D-Art-min-947x1024.jpg", alt: "Design 2" },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/promo_amanda.jpg", alt: "Design 3" },
      {
        src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/3a7ab9112768871.602fbfbfa228c-882x1024.jpg",
        alt: "Design 4",
      },
      { src: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_8-min-1024x970.jpg", alt: "Design 5" },
    ],
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Image
            src="https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/scribble.png"
            alt=""
            fill
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-3 border-t border-white/12 pt-5">
                <div className="relative h-11 w-11 shrink-0 overflow-hidden rounded-full ring-2 ring-[#ff8c3a]/40">
                  <Image
                    src="https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_1-min-1024x970.jpg"
                    alt=""
                    fill
              ...
              {[
                {
                  ...
                  name: "Tom Brunner",
                  role: "Indie dev",
                  avatar: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_5-min-1024x970.jpg",
                  stars: 5,
                },
                {
                  quote:
                  ...
                  name: "Adel Wazir",
                  role: "Producer",
                  avatar: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_6-min-1024x970.jpg",
                  stars: 5,
                },
                {
                  quote:
                  ...
                  name: "Tom Johnson",
                  role: "Art director",
                  avatar: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_8-min-1024x970.jpg",
                  stars: 4,
                },
                {
                  quote:
                  ...
                  name: "Peter Wilson",
                  role: "Studio lead",
                  avatar: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/sinspired/character_10-min-1024x970.jpg",
                  stars: 5,
                },
              ].map((r, idx) => (
                <motion.article
            ...
            <div className="relative grid min-h-[380px] gap-8 md:min-h-[460px] md:grid-cols-[1.25fr_1fr] md:items-center md:gap-10">
              <div className="relative mx-auto flex w-full max-w-[520px] items-center justify-center md:max-w-none md:justify-end">
                <div className="relative h-[min(420px,78vw)] w-full max-w-[420px] md:h-[520px] md:max-w-[480px]">
                  <Image
                    src="https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/video/CutScene_SE/1.gif"
                    alt="Character"
                    fill
                    className="object-contain"
        ...
        >
          ...
          <div className="relative mt-10 md:mt-14">
            ...
            <div className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden border-y border-white/[0.06] bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,transparent_28%,transparent_72%,rgba(0,0,0,0.25)_100%)] py-10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] md:py-12">
              ...
              >
                {[
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-26-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-27-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-28-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-29-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-30-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-26-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-27-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-28-min-300x141.png",
                  "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/Frame-29-min-300x141.png",
            ...
            {[
              {
                ...
                date: "01.22.2024",
                image: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/blog-1.jpg",
              },
              {
                title: "High poly and low poly modeling",
                date: "01.22.2024",
                image: "https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/images/blog-2.jpg",
              },
              {
          ...
          <div className="mt-14 grid gap-6 rounded-3xl border border-white/10 bg-white/5 p-8 md:grid-cols-[1fr_180px] md:items-center md:p-10">
            ...
            <div className="relative mx-auto h-[160px] w-[160px]">
              <Image
                src="https://pub-97eae399068b4753bb314896c009c27e.r2.dev/landing/logoCompany/5-min-1-1024x970.jpg"
                alt="Mascot"
                fill
